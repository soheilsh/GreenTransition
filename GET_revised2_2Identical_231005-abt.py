...
alphab0 = 0.5                                       # Initial share of Brown good in the consumption composite
...
gsigmab1 = -0.0152                                  # Initial growth of sigma (per year) *0.5
...
sigg0 = (e0/q0)                                     # Initial emission intensity of output in Green sector
...
pab = 0.50                           # Power of capital productivity growth in Brown sector  0725 * 5 0.55
pag = 0.50                           # Power of capital productivity growth in Green sector  

pbb = 0.20                           # Power of human productivity growth in Brown sector  0.25
pbg = 0.20                           # Power of human productivity growth in Green sector
...
tccapg_l = 0 #1e-1
tccapb_l = 0 #1e-1
tclabg_q = 2e-5                            # Quadratic transfer cost parameters (3e-5)
tclabb_q = 2e-5
tccapg_q = 2e-4
tccapb_q = 2e-4

alphagLin = [0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90] + 82*[0.9]
alphagDel = [0.05, 0.06, 0.07, 0.08, 0.09, 0.10, 0.11, 0.12, 0.20, 0.28, 0.35, 0.43, 0.51, 0.59, 0.67, 0.74, 0.82, 0.90] + 82*[0.9]
alphagFst = [0.05, 0.16, 0.26, 0.37, 0.48, 0.59, 0.69, 0.80, 0.81, 0.82, 0.83, 0.84, 0.85, 0.86, 0.87, 0.88, 0.89, 0.90] + 82*[0.9]
# ========================================= Transition Function ========================================= #
...
def state( ST1, EX1, Act1 ):
    ...
    RDin = (Ab1 * Krd_b)**thetab * (Bb1 * Lrd_b/1000)**(1 - thetab) + (Ag1 * Krd_g)**thetag * (Bg1 * Lrd_g/1000)**(1 - thetag)
    RDink = rdk1 * RDin
    rdl1 = 1 - rdk1
    RDinl = rdl1 * RDin
    ...
    Yb1 = max(1, YGROSSb1 - DAMAGEb1 - CTLgb1 - CTKgb1 - ABTCOSTb1)	
    Yg1 = max(1, YGROSSg1 - DAMAGEg1 - CTLbg1 - CTKbg1 - ABTCOSTg1)
    Y1 = Yb1 + Yg1
...
GET_GAMS_alt = [5.115, 5.535714286, 5.978890926, 6.444808261, 6.933692557, 7.44571697, 7.981000815, 8.539609154, 9.121552662, 9.726787805, 10.35521729, 11.00669076, 11.6810058, 12.37790913, 13.09709801, 13.8382219, 14.60088427, 15.38464458, 16.18902041, 17.01348968, 17.8574931, 18.72043652, 19.60169353, 20.500608, 21.41649668, 22.3486519, 23.29634412, 24.2588246, 25.23532803, 26.22507503, 27.22727473, 28.24112718, 29.2658258, 30.30055966, 31.34451569, 32.3968809, 33.45684436, 34.52359921, 35.59634445, 36.67428674, 37.75664201, 38.84263699, 39.93151064, 41.02251547, 42.11491874, 43.20800355, 44.30106988, 45.39343542, 46.48443641, 47.57342834, 48.65978656, 49.74290674, 50.82220539, 51.89712015, 52.96711006, 54.03165578, 55.0902597, 56.14244601, 57.18776069, 58.22577142, 59.25606753, 60.27825976, 61.29198009, 62.2968815, 63.2926376, 64.27894239, 65.25550985, 66.22207353, 67.17838618, 68.12421929, 69.05936261, 69.98362371, 70.89682746, 71.79881556, 72.68944597, 73.56859246, 74.43614405, 75.29200445, 76.13609161, 76.96833711, 77.78868568, 78.59709465, 79.39353343, 80.177983, 80.95043541, 81.71089324, 82.45936915, 83.19588535, 83.92047315, 84.63317248, 85.33403145, 86.02310587, 86.70045884, 87.36616034, 88.02028677, 88.66292062, 89.29415, 89.91406834, 90.52277398, 91.12036985]
...
output('GET_Output_2ID.xls', output1)
