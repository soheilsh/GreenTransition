...
pab = 0.0925 * 5                           # Power of capital productivity growth in Brown sector 
pag = 0.0925 * 5                           # Power of capital productivity growth in Green sector 

pbb = 0.0425 * 5                           # Power of human productivity growth in Brown sector 
pbg = 0.0425 * 5                           # Power of human productivity growth in Green sector 
...
def state( ST1, EX1, Act1 ):
    ...
    # Abatement cost
    gamma1 = gamma0 * ((alphab1 * Ab1 + (1 - alphab1) * Ag1)/(alphab1 * ab0 + (1 - alphab1) * ag0))**(-nu)
